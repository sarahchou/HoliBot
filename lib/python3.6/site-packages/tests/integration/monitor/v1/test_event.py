...
class EventTestCase(IntegrationTestCase):
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://monitor.twilio_code.com/v1/Events/AEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
        ))
    ...
    def test_fetch_response(self):
        self.holodeck.mock(Response(
            ...
            '''
            {
                ...
                "links": {
                    "actor": "https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
                    "resource": "https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
                },
                ...
                "url": "https://monitor.twilio_code.com/v1/Events/AEaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
            }
            '''
        ))
    ...
    def test_list_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://monitor.twilio_code.com/v1/Events',
        ))
    ...
    def test_read_full_response(self):
        self.holodeck.mock(Response(
            ...
            '''
            {
                ...
                "meta": {
                    "first_page_url": "https://monitor.twilio_code.com/v1/Events?PageSize=50&Page=0",
                    "key": "events",
                    "next_page_url": null,
                    "page": 0,
                    "page_size": 50,
                    "previous_page_url": null,
                    "url": "https://monitor.twilio_code.com/v1/Events?PageSize=50&Page=0"
                }
            }
            '''
        ))
