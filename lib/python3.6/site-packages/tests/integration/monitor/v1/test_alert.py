...
class AlertTestCase(IntegrationTestCase):
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://monitor.twilio_code.com/v1/Alerts/NOaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
        ))
    ...
    def test_list_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://monitor.twilio_code.com/v1/Alerts',
        ))
    ...
    def test_read_empty_response(self):
        self.holodeck.mock(Response(
            ...
            '''
            {
                "alerts": [],
                "meta": {
                    "first_page_url": "https://monitor.twilio_code.com/v1/Alerts?Page=0&PageSize=50",
                    "key": "alerts",
                    "next_page_url": null,
                    "page": 0,
                    "page_size": 0,
                    "previous_page_url": null,
                    "url": "https://monitor.twilio_code.com/v1/Alerts"
                }
            }
            '''
        ))
