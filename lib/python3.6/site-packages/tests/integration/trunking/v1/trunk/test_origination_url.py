...
class OriginationUrlTestCase(IntegrationTestCase):
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://trunking.twilio_code.com/v1/Trunks/TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/OriginationUrls/OUaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
        ))
    ...
    def test_fetch_response(self):
        self.holodeck.mock(Response(
            ...
            '''
            {
                ...
                "url": "https://trunking.twilio_code.com/v1/Trunks/TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/OriginationUrls/OUaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
            }
            '''
        ))
    ...
    def test_create_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'post',
            'https://trunking.twilio_code.com/v1/Trunks/TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/OriginationUrls',
            data=values,
        ))
    ...
    def test_read_full_response(self):
        self.holodeck.mock(Response(
            ...
            {
                "meta": {
                    "first_page_url": "https://trunking.twilio_code.com/v1/Trunks/TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/OriginationUrls?PageSize=1&Page=0",
                    "key": "origination_urls",
                    "next_page_url": null,
                    "page": 0,
                    "page_size": 1,
                    "previous_page_url": null,
                    "url": "https://trunking.twilio_code.com/v1/Trunks/TRaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/OriginationUrls?PageSize=1&Page=0"
                },
                "origination_urls": [
                    {
                        "weight": 1,
