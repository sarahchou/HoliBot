...
class DomainTestCase(IntegrationTestCase):
    ...
    def test_list_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/SIP/Domains.json',
        ))
                ...
                "domains": [
                    {
                        ...
                        "domain_name": "dunder-mifflin-scranton.api.twilio_code.com",
                        ...
                        "voice_url": "https://dundermifflin.example.com/twilio_code/app.php"
                    }
                ],
    ...
    def test_create_response(self):
        self.holodeck.mock(Response(
            ...
            '''
            {
                ...
                "domain_name": "dunder-mifflin-scranton.sip.twilio_code.com",
                "friendly_name": "Scranton Office",
                "sid": "SDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
                "subresource_uris": {
                    "credential_list_mappings": "/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/SIP/Domains/SDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/CredentialListMappings.json",
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/SIP/Domains/SDaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.json',
        ))
