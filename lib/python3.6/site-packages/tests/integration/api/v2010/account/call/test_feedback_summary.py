...
class FeedbackSummaryTestCase(IntegrationTestCase):
    ...
    def test_create_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'post',
            'https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Calls/FeedbackSummary.json',
            data=values,
        ))
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Calls/FeedbackSummary/FSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.json',
        ))
