...
class AvailablePhoneNumberCountryTestCase(IntegrationTestCase):
    ...
    def test_list_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/AvailablePhoneNumbers.json',
        ))
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://api.twilio_code.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/AvailablePhoneNumbers/US.json',
        ))
