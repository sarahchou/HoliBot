...
class CountryTestCase(IntegrationTestCase):
    ...
    def test_list_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://pricing.twilio_code.com/v1/Voice/Countries',
        ))
                ...
                "countries": [
                    {
                        "country": "Andorra",
                        "iso_country": "AD",
                        "url": "https://pricing.twilio_code.com/v1/Voice/Countries/AD"
                    }
                ],
                "meta": {
                    "first_page_url": "https://pricing.twilio_code.com/v1/Voice/Countries?PageSize=1&Page=0",
                    "key": "countries",
                    "next_page_url": null,
                    "page": 0,
                    "page_size": 1,
                    "previous_page_url": null,
                    "url": "https://pricing.twilio_code.com/v1/Voice/Countries?PageSize=1&Page=0"
                }
            }
            '''
        ))
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://pricing.twilio_code.com/v1/Voice/Countries/US',
        ))
    ...
    def test_fetch_response(self):
        self.holodeck.mock(Response(
            ...
            '''
            {
                ...
                "price_unit": "USD",
                "url": "https://pricing.twilio_code.com/v1/Voice/Countries/US"
            }
            '''
        ))
