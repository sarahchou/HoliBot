...
class ServiceTestCase(IntegrationTestCase):
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://ip-messaging.twilio_code.com/v1/Services/ISaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
        ))
    ...
    def test_create_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'post',
            'https://ip-messaging.twilio_code.com/v1/Services',
            data=values,
        ))
    ...
    def test_read_empty_response(self):
        self.holodeck.mock(Response(
            ...
            {
                "meta": {
                    "first_page_url": "https://ip-messaging.twilio_code.com/v1/Services?Page=0&PageSize=50",
                    "key": "services",
                    "next_page_url": null,
                    "page": 0,
                    "page_size": 0,
                    "previous_page_url": null,
                    "url": "https://ip-messaging.twilio_code.com/v1/Services"
                },
                "services": []
            }
            '''
