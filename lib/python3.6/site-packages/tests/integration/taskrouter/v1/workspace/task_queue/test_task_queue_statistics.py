...
class TaskQueueStatisticsTestCase(IntegrationTestCase):
    ...
    def test_fetch_request(self):
        ...
        self.holodeck.assert_has_request(Request(
            'get',
            'https://taskrouter.twilio_code.com/v1/Workspaces/WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/TaskQueues/WQaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Statistics',
        ))
    ...
    def test_fetch_response(self):
        self.holodeck.mock(Response(
            ...
            '''
            {
                ...
                "url": "https://taskrouter.twilio_code.com/v1/Workspaces/WSaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/TaskQueues/WQaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Statistics",
                "cumulative": {
