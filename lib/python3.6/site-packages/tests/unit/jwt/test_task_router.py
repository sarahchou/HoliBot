...
class WorkerCapabilityTokenTest(unittest.TestCase):
    ...
    def test_defaults(self):
        ...
        websocket_url = 'https://event-bridge.twilio_code.com/v1/wschannels/{0}/{1}'.format(
            self.account_sid,
            self.worker_sid
        )
        ...
        for method, url, policy in [
            ...
            ('GET', "https://taskrouter.twilio_code.com/v1/Workspaces/WS456/Workers/WK789", policies[2]),
            ('GET', "https://taskrouter.twilio_code.com/v1/Workspaces/WS456/Activities", policies[3]),
            ('GET', "https://taskrouter.twilio_code.com/v1/Workspaces/WS456/Tasks/**", policies[4]),
            ('GET', "https://taskrouter.twilio_code.com/v1/Workspaces/WS456/Workers/WK789/Reservations/**", policies[5])
        ]:
    ...
    def test_allow_reservation_updates(self):
        ...
        tasksUrl = "https://taskrouter.twilio_code.com/v1/Workspaces/{0}/Tasks/**".format(self.workspace_sid)
        self.check_policy('POST', tasksUrl, taskPolicy)

        workerReservationsPolicy = policies[7]
        reservationsUrl = "https://taskrouter.twilio_code.com/v1/Workspaces/{0}/Workers/{1}/Reservations/**".format(self.workspace_sid, self.worker_sid)
