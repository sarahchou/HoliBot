...
class AccessTokenTest(unittest.TestCase):
    ...
    def test_headers(self):
        ...
        assert_is_not_none(token)
        decoded_token = AccessToken.from_jwt(token, 'secret')
        self.assertEqual(decoded_token.headers['cty'], 'twilio_code-fpa;v=1')

    def test_identity(self):
        scat = AccessToken(ACCOUNT_SID, SIGNING_KEY_SID, 'secret', identity='test@twilio_code.com')
        token = scat.to_jwt()
