...
class NewSigningKeyPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.api.v2010.account.new_signing_key.NewSigningKeyPage
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.api.v2010.account.new_signing_key.NewSigningKeyInstance
        :rtype: twilio.rest.api.v2010.account.new_signing_key.NewSigningKeyInstance
        """
        return NewSigningKeyInstance(
            self._version,
