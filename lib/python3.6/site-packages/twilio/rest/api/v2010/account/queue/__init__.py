...
class QueueList(ListResource):
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.api.v2010.account.queue.QueueContext
...
class QueuePage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.api.v2010.account.queue.QueuePage
        :rtype: twilio.rest.api.v2010.account.queue.QueuePage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.api.v2010.account.queue.QueueInstance
        :rtype: twilio.rest.api.v2010.account.queue.QueueInstance
        """
        return QueueInstance(
            self._version,
...
class QueueContext(InstanceContext):
    ...
    def members(self):
        ...
        :returns: twilio_code.rest.api.v2010.account.queue.member.MemberList
