...
class MessageList(ListResource):
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.api.v2010.account.message.MessageContext
...
class MessagePage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.api.v2010.account.message.MessagePage
        :rtype: twilio.rest.api.v2010.account.message.MessagePage
        """
...
class MessageContext(InstanceContext):
    ...
    def feedback(self):
        ...
        :returns: twilio_code.rest.api.v2010.account.message.feedback.FeedbackList
