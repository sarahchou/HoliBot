...
class PayloadList(ListResource):
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.api.v2010.account.recording.add_on_result.payload.PayloadContext
...
class PayloadPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.api.v2010.account.recording.add_on_result.payload.PayloadPage
        :rtype: twilio.rest.api.v2010.account.recording.add_on_result.payload.PayloadPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.api.v2010.account.recording.add_on_result.payload.PayloadInstance
