...
class ThisMonthPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.api.v2010.account.usage.record.this_month.ThisMonthPage
        :rtype: twilio.rest.api.v2010.account.usage.record.this_month.ThisMonthPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.api.v2010.account.usage.record.this_month.ThisMonthInstance
