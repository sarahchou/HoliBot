...
class AddOnResultList(ListResource):
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.api.v2010.account.recording.add_on_result.AddOnResultContext
...
class AddOnResultPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.api.v2010.account.recording.add_on_result.AddOnResultPage
        :rtype: twilio.rest.api.v2010.account.recording.add_on_result.AddOnResultPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.api.v2010.account.recording.add_on_result.AddOnResultInstance
...
class AddOnResultContext(InstanceContext):
    ...
    def payloads(self):
        ...
        :returns: twilio_code.rest.api.v2010.account.recording.add_on_result.payload.PayloadList
