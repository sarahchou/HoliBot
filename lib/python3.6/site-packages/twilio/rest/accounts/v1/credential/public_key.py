...
class PublicKeyList(ListResource):
    ...
    def __init__(self, version):
        ...
        :returns: twilio_code.rest.accounts.v1.credential.public_key.PublicKeyList
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.accounts.v1.credential.public_key.PublicKeyContext
...
class PublicKeyPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.accounts.v1.credential.public_key.PublicKeyPage
        :rtype: twilio.rest.accounts.v1.credential.public_key.PublicKeyPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.accounts.v1.credential.public_key.PublicKeyInstance
        :rtype: twilio.rest.accounts.v1.credential.public_key.PublicKeyInstance
        """
        return PublicKeyInstance(
            self._version,
...
class PublicKeyInstance(InstanceResource):
    ...
    def url(self):
        """
        :returns: The URI for this resource, relative to `https://accounts.twilio_code.com`
        :rtype: unicode
        """
