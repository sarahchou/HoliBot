...
class TaskList(ListResource):
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task.TaskContext
...
class TaskPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task.TaskPage
        :rtype: twilio.rest.taskrouter.v1.workspace.task.TaskPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task.TaskInstance
        :rtype: twilio.rest.taskrouter.v1.workspace.task.TaskInstance
        """
        return TaskInstance(
            self._version,
...
class TaskContext(InstanceContext):
    ...
    def reservations(self):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task.reservation.ReservationList
