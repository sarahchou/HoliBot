...
class EventList(ListResource):
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.event.EventContext
...
class EventPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.event.EventPage
        :rtype: twilio.rest.taskrouter.v1.workspace.event.EventPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.event.EventInstance
