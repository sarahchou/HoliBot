...
class TaskQueueList(ListResource):
    ...
    def get(self, sid):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.TaskQueueContext
...
class TaskQueuePage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.TaskQueuePage
        :rtype: twilio.rest.taskrouter.v1.workspace.task_queue.TaskQueuePage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.TaskQueueInstance
        :rtype: twilio.rest.taskrouter.v1.workspace.task_queue.TaskQueueInstance
        """
        return TaskQueueInstance(
            self._version,
...
class TaskQueueContext(InstanceContext):
    ...
    def task_queues_statistics(self):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.task_queues_statistics.TaskQueuesStatisticsList
    ...
    def task_queue_statistics(self):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.task_queue_statistics.TaskQueueStatisticsList
