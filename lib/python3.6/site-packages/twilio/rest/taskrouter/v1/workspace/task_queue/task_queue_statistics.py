...
class TaskQueueStatisticsList(ListResource):
    ...
    def get(self):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.task_queue_statistics.TaskQueueStatisticsContext
...
class TaskQueueStatisticsPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.task_queue_statistics.TaskQueueStatisticsPage
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.taskrouter.v1.workspace.task_queue.task_queue_statistics.TaskQueueStatisticsInstance
