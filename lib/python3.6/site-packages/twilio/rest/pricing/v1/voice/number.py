...
class NumberList(ListResource):
    ...
    def get(self, number):
        ...
        :returns: twilio_code.rest.pricing.v1.voice.number.NumberContext
...
class NumberPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: twilio_code.rest.pricing.v1.voice.number.NumberPage
    ...
    def get_instance(self, payload):
        ...
        :returns: twilio_code.rest.pricing.v1.voice.number.NumberInstance
